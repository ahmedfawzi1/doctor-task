            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <a type="button" href="{{ route('doctors.create') }}" class="btn btn-light mb-4">Add New Doctor</a>
                                <div class="row">
                                    <div class="col-md-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h6 class="card-title">Doctors Table</h6>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        @foreach ($doctor->schedule as $schedule)
                                                                            <span
                                                                                class="badge bg-light text-dark">{{ $schedule->day }}</span>
                                                                        @endforeach
                                                                    </th>
                                                                </tr>
                                                            @endforeach
